DROP VIEW IF EXISTS public.member_secondary_school_education_46;
...
FROM member_aph_46 m
         ...
         LEFT JOIN education_acara ea ON e.id = ea.education_id
...
alter table public.member_secondary_school_education_46
    owner to cam;
